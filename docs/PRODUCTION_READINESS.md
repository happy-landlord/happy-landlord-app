...
_Last updated: 2026-09-15 (rev 4)_

Audit of HLApp (Expo SDK 57 / RN 0.86 / Expo Router 57 / Supabase / TanStack Query v5).
...
| Item                                         | Status | Notes                                                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App name, slug, version, scheme              | ✅     | `app.json` (`Key Manager`, `happy-landlord-app`, `1.0.6`, `hlapp`). ⚠️ `package.json` `version` still `1.0.0` (cosmetic — build numbers come from EAS remote source).                                                                                                                                                                                                                       |
...
| New Architecture + React Compiler            | ✅     | New Architecture is mandatory in SDK 57; React Compiler is enabled with `experiments.reactCompiler`.                                                                                                                                                                                                                                                                                        |
